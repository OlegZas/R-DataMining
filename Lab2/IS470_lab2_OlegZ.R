...
cor(carAuction[,c('MMRCurrentAuctionAveragePrice','VehBCost','VehicleAge','VehOdo', 'WarrantyCost')])
...
#section were gone after software disconencted me. I will need to doing again to print it out and study.
...
# Spent about 2hours on first section, since i was pausing and writing comments,
